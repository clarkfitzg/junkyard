...
```{r, Residuals, results='hide', fig.height = 4}
par(mfrow=c(1, 3))
...
From the ANOVA table we see that $SSR(X_2 | X_4)$ is small, 9.3 compared to
40.5 when it's the only term in the model. This is due to
